...
##Features and specs of Hololens 2
1.Hololens 2 allows the ease of use, as it can be easily used monitor and interact with the uerser's environment. 
...
3. With some outstaanding features like built in voice command, eye tracking, hand tracking, etc, what is actually needed is the accuracy and Hololens 2 definately stands on the top when it comes to accuracy.
4. Specs
 1. Optics- See- Through holographic lenses
 2. Resolution- 2k 3:2 light engines
 3. Eye Based rendering- Display optimization for 3D eye position
 4. Speaker- Built-in spatial sound
 5. Eye Tracking- Real Time Tracking
 6. Weight- 566g
